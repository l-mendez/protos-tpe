...
#define ck_assert_int_ge(a, b) assert((a) >= (b))
#define ck_assert_int_gt(a, b) assert((a) > (b))
#define ck_assert_int_lt(a, b) assert((a) < (b))
#define ck_assert_uint_eq(a, b) assert((a) == (b))
#define ck_assert_uint_ne(a, b) assert((a) != (b))
#define ck_assert_uint_ge(a, b) assert((a) >= (b))
#define ck_assert_ptr_eq(a, b) assert((a) == (b))
#define ck_assert_ptr_ne(a, b) assert((a) != (b))
#define ck_assert_ptr_null(a) assert((a) == NULL)
#define ck_assert_ptr_nonnull(a) assert((a) != NULL)
#define ck_assert_str_eq(a, b) assert(strcmp((a), (b)) == 0)
#define ck_assert_str_ne(a, b) assert(strcmp((a), (b)) != 0)
